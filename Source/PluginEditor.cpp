        ...
        juce::Slider& slider)
{
    ...
    g.setColour(enabled ? Colour(3u, 57u, 51u): Colour(51u, 51u, 51u));
    g.fillEllipse(bounds);
    g.setColour(enabled ? Colour(30u, 119u, 109u): Colour(79u, 79u, 79u));
    ...
    if (auto* rswl = dynamic_cast<RotarySliderWithLabels*>(& slider))
    {
        ...
        g.setColour(enabled ? Colour(20u, 20u, 20u) : Colour(51u, 51u, 51u));
        g.fillRect(r);

        g.setColour(enabled ? Colours::white : Colour(51u, 51u, 51u));
        g.drawFittedText(text, r.toNearestInt(), juce::Justification::centred, 1);
    }
    
}

void LookAndFeel::drawToggleButton(juce::Graphics& g, juce::ToggleButton& toggleButton, bool shouldDrawButtonAsHiglighted, bool shouldDrawButtonAsDown)
{
    using namespace juce;
    ...
    if (auto* pb = dynamic_cast<PowerButton*>(&toggleButton))
    {
        ...
        auto color = toggleButton.getToggleState() ? Colour(51u, 51u, 51u) : Colour(30u, 119u, 109u);
...
void RotarySliderWithLabels::paint(juce::Graphics& g)
{
    ...
    */
    ...
    for (int i = 0; i < numChoices; ++i)
    {
        ...
        r.setSize(g.getCurrentFont().getStringWidth(str), getParentHeight());
        r.setCentre(c);
...
void ResponseCurveComponent::paint(juce::Graphics& g)
{
    ...
    if (shouldShowFFTAnalysis)
    {
        ...
        g.setColour(Colour(21u, 112u, 122u));
    ...
    g.drawRoundedRectangle(getRenderArea().toFloat(), 4.f, 3.f);
    ...
    analyzerEnabledButtonAttachment(audioProcessor.apvts, "Analyzer Enabled", analyzerEnabledButton)
{
    ...
    analyzerEnabledButton.onClick = [safePtr]()
    {
        if (auto* comp = safePtr.getComponent())
        {
            ...
            comp->responseCurveComponent.togleAnalysisEnablement(enabled);
        }
    };
...
void SimpleEQAudioProcessorEditor::resized()
{
    ...
    float hRatio = 25.f / 100.f;    //JUCE_LIVE_CONSTANT(33.f) / 100.f;
...
std::vector<juce::Component*> SimpleEQAudioProcessorEditor::getComps() {
    return 
    {
        ...
        &lowCutBypassedButton, &peakBypassedButton, &highCutBypassedButton, &analyzerEnabledButton
    };
}